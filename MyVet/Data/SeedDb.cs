...
namespace MyVet.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckRoles();
            var manager = await CheckUserAsync("0801", "Gerardo", "Lanza", "glanza007@gmail.com", "350 634 2747", "Calle Luna Calle Sol", "Admin");
            var customer = await CheckUserAsync("1987", "Gerardo", "Lanza", "glanza007@hotmail.com", "350 634 2747", "Calle Luna Calle Sol", "Customer");
