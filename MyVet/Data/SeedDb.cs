...
namespace MyVet.Data
{
    public class SeedDb
    {
        ...
        private async Task CheckOwnersAsync()
        {
            ...
            {
                AddOwner("8989898", "Gerardo", "Lanza", "234 3232", "310 322 3221", "Calle Luna Calle Sol");
                AddOwner("7655544", "Janeth", "Zepeda", "343 3226", "300 322 3221", "Calle 77 #22 21");
                AddOwner("6565555", "Astrid", "Durón", "450 4332", "350 322 3221", "Carrera 56 #22 21");
                await _context.SaveChangesAsync();
            }
        }
